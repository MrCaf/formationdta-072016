...
public class IhmHelperClient {
	...
	public IhmHelperClient(Stockage<Pizza, String> stockagePizza, Stockage<Client, Integer> stockageClient, Stockage<Livreur, Integer> stockageLivreur, Scanner scanner) {
		super();
